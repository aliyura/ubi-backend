...
export class BillController {
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getAirtimeNetworkProviders })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getDataNetworkProviders })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getInternationalAirtimePlan })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getAirtimeFxRate })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getElectricityPlan })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getTransportPlan })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getSchoolfeePlan })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getAirtimeVariation })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getDataVariation })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.internationalAirtimePay })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getGiftCardCategories })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getProductByISOCode })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getGiftCardFxRate })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getCableBillInfo })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getElectricityBillInfo })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getInternetBillInfo })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getTransportBillInfo })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getSchoolfeeBillInfo })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.verifyCableNumber })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.verifyMeterNumber })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.electricityPay })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.giftcardPay })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getGiftCardRedeemCode })
  ...
  @ApiResponse({ status: HttpStatus.OK, example: billResponse.getBeneficiaries })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.internetPay })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.transportPay })
  ...
  @ApiResponse({ status: HttpStatus.CREATED, example: billResponse.schoolfeePay })
